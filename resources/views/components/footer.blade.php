<footer class="bg-navy text-white">
    <div class="mx-auto grid w-full max-w-7xl gap-10 px-4 pb-10 pt-12 sm:px-6 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
        <div class="flex flex-col gap-3">
            ...
            <p class="text-sm leading-relaxed text-steel-bright">
                Examination gazettes, daily attendance registers, and fee ledgers —
                published by the school office for parents and guardians.
            </p>
            <div class="flex flex-wrap items-center gap-2 pt-1">
                <span class="rounded bg-white/10 px-2 py-1 text-[11px] font-semibold text-glow">Official Records</span>
                <span class="rounded bg-white/10 px-2 py-1 text-[11px] font-semibold text-steel-bright">GR Registry</span>
            </div>
        </div>

        <div class="flex flex-col gap-3">
            <span class="text-sm font-semibold uppercase tracking-wider text-white">Quick Links</span>
            <ul class="flex flex-col gap-2 text-sm text-steel-bright">
                @foreach (['results' => 'Examination Results & Gazette', 'attendance' => 'Attendance Records', 'fees' => 'Fee Vouchers & Receipts'] as $route => $label)
                    <li>
                        <a href="/{{ $route }}" class="flex items-center gap-1.5 rounded py-1 transition-colors hover:text-white">
        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="flex flex-col gap-1.5 text-sm text-steel-bright">
                <p>
            ...
            <div class="flex flex-col gap-2 rounded-lg bg-white/5 p-4">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <span class="text-xs text-steel-bright">Records &amp; Verification</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="border-t border-white/10">
        <div class="mx-auto flex w-full max-w-7xl flex-col items-center gap-2 px-4 py-4 text-xs text-steel-bright sm:px-6 lg:px-8">
