...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .band { background: linear-gradient(135deg, #1e3a8a, #3b82f6); color: #fff; padding: 16px 20px; }
        ...
        .sr { margin-top: 6px; display: inline-block; background: #eff6ff; color: #1e3a8a; font-weight: 700; font-size: 12px; padding: 3px 10px; border-radius: 999px; }
        .footer { padding: 0 20px 16px; font-size: 10px; color: #9ca3af; }
        .print button { font-family: system-ui; padding: 10px 24px; background: #1e3a8a; color: #fff; border: none; cursor: pointer; border-radius: 8px; }
...
<body>
    <div class="card">
        <div class="band">
            ...
            <div class="tag">Student ID Card</div>
        </div>
        <div class="body">
