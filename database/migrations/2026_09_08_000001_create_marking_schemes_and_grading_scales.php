...
/*
 * Exam marking configuration.
 *
 * Marking schemes: admin-defined mark limits per class and subject.
 * Without a row the default bounds (0 - 100) apply, matching the
 * legacy sheets. Grading scales: admin-defined grade boundaries
 * (percentage thresholds); without rows the built-in boundaries
 * (A+ 90, A 80, ...) apply.
 *
...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('marking_schemes')) {
